...
features of this DAQ. \emph{Each} instruction is a seperate command
...
\item[daq\_setfilerule file-rule] Set the file rule. You should always
  ...
  area where rcdaq was started from.  Be sure to have a look at the 4 comamnds
...
an ``insall'' directory, and buld in the standard way. In this
